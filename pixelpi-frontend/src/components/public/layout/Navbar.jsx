...
function NavLink({ to, children, isActive, onClick }) {
  return (
    <Link
      to={to}
      onClick={onClick}
      className="px-3 py-1.5 rounded-md font-body text-label transition-colors duration-fast"
      style={{
        color: isActive
...
export function Navbar() {
  ...
  const glassStyle = {
    ...
    background:             scrolled ? 'rgba(13, 18, 32, 0.92)' : 'rgba(13, 18, 32, 0.65)',
    border:                 '1px solid var(--color-border-strong)',
    boxShadow:              scrolled
                              ? '0 8px 32px rgba(0, 0, 0, 0.40)'
                              : '0 2px 16px rgba(0, 0, 0, 0.20)',
    transition:             `background ${150}ms ease, backdrop-filter ${150}ms ease, box-shadow ${150}ms ease`,
  };
    ...
    <>
      ...
      >
        ...
        <nav
          ...
          style={{ ...glassStyle, height: '52px', borderRadius: '9999px' }}
